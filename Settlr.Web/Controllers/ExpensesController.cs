...
public class ExpensesController : ControllerBase
{
    ...
    {
        Response<ExpenseDto> response = await _expenseService.CreateExpenseAsync(request, cancellationToken);
    ...
    {
        Response<List<ExpenseDto>> response = await _expenseService.GetGroupExpensesAsync(groupId, cancellationToken);
        return StatusCode(response.StatusCode, response);
    }
}
